...
|---|---|---|---|---|
| **OI-7** | EU ETS scope for IANO: **CONFIRMED YES by user 2026-05-13**. IANO is registered as EU ETS Annex I Activity 17 (manufacture of ceramic products by firing) installation. AR5 dual-track regeneration is required for ETS submissions in parallel to AR6 CSRD disclosure. MG-12 elevated from Conditional to Mandatory. | sustainability-expert-agent + data-engineer-agent | Phase 5 | Yes — Phase 5 must wire production-ready AR5 dual-track |
| **OI-8** | Cat 15 — Financed emissions: **CLOSED 2026-05-13 by user — no financial investments held material to Cat 15** (no equity stakes, no pension-fund assets, no project finance, no treasury investment portfolio). Cat 15 OMIT-with-rationale confirmed for ESRS E1-6 disclosure line. | sustainability-expert-agent | Closed | No |
| **OI-9** | **CLOSED 2026-05-13** by user via Phase 4 ADR-007: separate-schema option adopted. Two columns `co2_biogenic_tonne` + `co2_fossil_tonne` added to `calc.emissions_consolidated` in migration M0; biogenic CO2 disclosed in ESRS E1-7 (Removals and Storage), NEVER netted against `tco2e`. Cat 1 cardboard/pallets dual-write per ecoinvent v3.10 biogenic flow. See architecture.md §16 ADR-007. | sustainability-expert + data-engineer + user | Closed | No |
| **OI-10** | Fugitive HFC emissions from facility cooling / refrigeration: **CLOSED 2026-05-13 by user — refrigerant top-ups are negligible across all 7 sites; Scope 1 fugitive HFC sub-category declared zero with rationale ("closed-loop systems, no material top-ups").** New MG-18 added: explicit zero-line for Scope 1 Fugitive HFC. | user + data steward | Closed | No |
...
| MG-12 | **MANDATORY (OI-7 confirmed YES 2026-05-13)**: AR5 dual-track regeneration wired and tested before any FY2024 disclosure publication. AR6 path → CSRD ESRS E1-6 PDF; AR5 path → fit-for-purpose internal output for EU ETS submission (regulatory XML/MRR format itself remains out of v1 scope but the underlying tCO2e values must be reproducible). | sustainability-expert-agent + data-engineer-agent | Yes |
| MG-13 | **CLOSED (OI-8 confirmed NO 2026-05-13)**: no Cat 15 financial-instrument scope exists. Cat 15 OMIT-with-rationale row auto-emitted per FR-18-analogue. | sustainability-expert-agent | Closed (informational) |
| MG-18 | **NEW (OI-10 confirmed zero 2026-05-13)**: Scope 1 Fugitive HFC zero-line auto-emitted in every ESRS E1-6 output with rationale "Closed-loop refrigeration systems; refrigerant top-ups across all 7 sites declared negligible by user; no material fugitive emissions to disclose." | data-analyst-agent + data-engineer-agent | Yes |
